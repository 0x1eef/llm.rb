...
ActiveRecord and uses the builtin MCP feature to connect to GitHub. The chatbot is an llm.rb agent that is deployed with [roda-llm](https://github.com/r-uby-dev/roda-llm).
